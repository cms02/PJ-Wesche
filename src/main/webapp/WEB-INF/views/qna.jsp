							...
							<div class="table-responsive">
								<table class="table align-items-center table-flush" style="text-align: center;">
									<thead class="thead-light">
										<tr>
											<th class="thcol" scope="col">No</th>
											<th class="thcol" scope="col">Title</th>
											<th class="thcol" scope="col">Writer</th>
											<th class="thcol" scope="col">Date</th>
											<th class="thcol" scope="col">Views</th>
											<th class="thcol" scope="col">Tags</th>
										</tr>
									</thead>
